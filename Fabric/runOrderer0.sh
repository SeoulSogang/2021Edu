...
ORDERER_GENERAL_LISTENADDRESS=10.0.1.XX ＼ (Orderer 주소)
...
ORDERER_GENERAL_TLS_ROOTCAS=[/root/testnet/crypto-config/ordererOrganizations/ordererorg0/orderers/orderer0.ordererorg0/tls/ca.crt,/root/
testnet/crypto-config/peerOrganizations/org0/peers/peer0.org0/tls/ca.crt] ＼
CONFIGTX_ORDERER_BATCHTIMEOUT=1s ＼
CONFIGTX_ORDERER_ORDERERTYPE=kafka ＼
CONFIGTX_ORDERER_KAFKA_BROKERS=[10.0.1.XX:9092] ＼ (Kafka 주소)
orderer
